...
import { FaCheckCircle, FaIdBadge, FaSpinner, FaUniversity } from "react-icons/fa";
            ...
            <div className="lg:col-span-2">
              ...
              <motion.div variants={itemVariants}>
                ...
                <h2 className="text-3xl font-bold mb-5 text-pink-400 flex items-center gap-2 drop-shadow">
                  <FaUniversity className="text-pink-400" />{" "}
                 <span className="text-indigo-400"> Branch Name:</span>{instituteData.currentUserData?.instituteName}
                </h2>
              </motion.div>
              <motion.div variants={itemVariants}>
                <h2 className="text-3xl font-bold mb-5 text-pink-400 flex items-center gap-2 drop-shadow">
                  <FaIdBadge className="text-pink-400" />{" "}
                   <span className="text-indigo-400"> Branch ID:</span>{instituteData.currentUserData?.branchId}
                </h2>
              </motion.div>
                ...
                <motion.div variants={itemVariants}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3 text-gray-300">
                    <p className="flex items-center gap-2">
                      ...
                      {instituteData.currentUserData?.username}
                    </p>
                    <p className="flex items-center gap-2">
                      <FiMail className="text-gray-500" />
                      <strong>Email:</strong>{" "}
                      {instituteData.currentUserData?.email}
                    </p>
                    <p className="flex items-center gap-2">
                      <FiPhone className="text-gray-500" />
                      <strong>Mobile:</strong>{" "}
                      {instituteData.currentUserData?.mobileNumber}
                    </p>
                    <p className="flex items-center gap-2">
                      <FiUser className="text-gray-500" />
                ...
                <motion.div variants={itemVariants}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3 text-gray-300">
                    <p className="flex items-center gap-2">
                      ...
                      {instituteData.currentUserData?.address}
                    </p>
                    <p className="flex items-center gap-2">
                      <FiBook className="text-gray-500" />
                      <strong>Post Office:</strong>{" "}
                      {instituteData.currentUserData?.postOffice}
                    </p>
                    <p className="flex items-center gap-2">
                      <MdOutlineApartment className="text-gray-500" />
                      <strong>Upazila:</strong>{" "}
                      {instituteData.currentUserData?.upazila}
                    </p>
                    <p className="flex items-center gap-2">
                      <FiMapPin className="text-gray-500" />
                      <strong>District:</strong>{" "}
                      {instituteData.currentUserData?.district}
                    </p>
                  </div>
                </motion.div>
              </div>
